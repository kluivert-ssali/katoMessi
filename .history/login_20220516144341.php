...
<div class="form-container">
    <main class="form-signin">
      <form action="" method="post">
       ...
       <div class="form-floating">
          <input type="password" name="password" required placeholder="enter your password" class="form-control" id="floatingInput">
       </div>
       <input type="submit" name="submit" value="login now" class="w-100 btn btn-lg btn-primary" class="form-control" id="floatingPassword">
