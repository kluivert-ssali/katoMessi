           ...
           <table class="table table-striped table-bordered table-hover">
              ...
              if ($result-> num_rows > 0) {
                   while ($row = $result->fetch_assoc()) {
                        echo "<tr><td>". $row["id"] . "</td><td>". $row["name"]. "</td><td>". $row["user_type"]. "</td><td>". $row["actived_"]. "</td><td>". "<button type='button' name='edit' class='btn btn-primary editbtn'>Edit</button> <button type='submit' name='delete' class='btn btn-danger'>Delete</button>".  "</td></tr>";
