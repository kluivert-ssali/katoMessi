...
<div class="form-container">
    <main class="form-signin">
      <form action="" method="post">
          <img id="logo" class="mb-4" width="72" height="57" src="https://admissions.ndu.ac.ug/resources/images/logos/ndejje.png">
          <h3>login now</h3>
          <?php
            if(isset($error)){
       ...
       <div class="form-floating">
          <input type="password" name="password" required placeholder="enter your password" class="form-control" id="floatingPassword">
       </div>
       ...
       <input type="submit" name="submit" value="login now" class="w-100 btn btn-lg btn-primary">
       <p class="mt-5 mb-3 text-muted">&copy; 201–2021</p>
