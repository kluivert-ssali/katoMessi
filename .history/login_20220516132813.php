...
// this is where the login session_start
session_start();

// checking of the login details in the database
...
//    the if loap that check for the user and directs him/her the page #this the access control logic
   ...
   if(mysqli_num_rows($result) > 0){
    ...
    //     //   where the user should go to
    //     header('location:doctor.php');

    //   }elseif($row['user_type'] == 'lab'){
    //       header('location:lab.php');

    //   }elseif($row['user_type'] == 'account.php'){
                    ...
                    <div class="formbg">
                        <div class="formbg-inner padding-horizontal--48">
                            ...
                            <form id="stripe-login" action="" method="post">
                                ...
                                <div class="field">
                                    <a class="" href="#">For staff members only</a>
                                </div>
                            </form>
                        </div>
                    </div>
