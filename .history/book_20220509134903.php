...
{  
      ...
      {  
           ...
           {  
                // echo '<script>alert("Booking Successful")</script>'; and redirect to the home page
...
// close connecting to database and return to home.php
...
<body>
    ...
    <div class="container" style="width:500px;">
        <form method="post">
            ...
            <br />
            <p align="center" ><input type="submit" name="book" value="Book Now" class="btn btn-success" />
            <!-- button that returns to home.php -->
            <input type="button" value="Back" class="btn btn-danger" onclick="window.location.href='home.php'" /></p>
