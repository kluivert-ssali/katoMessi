...
<body>
    ...
    <div class="container" style="width:500px;">
        <form method="post">
            ...
            <br />
            <label>Email</label>
            <input type="email" name="email" placeholder="070-22-23-132" required class="form-control" />
            ...
            <br />
            <p align="center"><input type="submit" name="book" value="Book Now" class="btn btn-success" /></p>
            <br />
        </form>
    </div>
