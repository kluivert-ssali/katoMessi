...
<body>
<?php 
    echo '<button style="position: absolute; font-size: 200%; top: 0; right: 0; width: 100px; text-align:right;" type="button" class="btn btn-danger"><a href="logout.php">Logout</a></button>'; 
?>
